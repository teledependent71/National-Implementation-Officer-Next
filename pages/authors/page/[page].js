...
import authorsPageInitialPaths4611aResource from '../../../resources/authors-page-initial-paths-4611a'
import authorsPageInitialPropsF223cResource from '../../../resources/authors-page-initial-props-f223c'
...
export async function getStaticPaths() {
  const response = await authorsPageInitialPaths4611aResource({})
...
export async function getStaticProps(context) {
  const response = await authorsPageInitialPropsF223cResource({
    ...context?.params,
