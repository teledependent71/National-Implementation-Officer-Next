...
import booksPageInitialPathsB7bf3Resource from '../../resources/books-page-initial-paths-b7bf3'
import booksPageInitialPropsA103eResource from '../../resources/books-page-initial-props-a103e'
  ...
  return (
    <>
      <div className="books11-container">
        <Head>
          <title>Books1 - National Implementation Officer</title>
          <meta
            property="og:title"
            content="Books1 - National Implementation Officer"
          />
        </Head>
        <DataProvider
...
export async function getStaticPaths() {
  const response = await booksPageInitialPathsB7bf3Resource({})
  return {
...
export async function getStaticProps(context) {
  const response = await booksPageInitialPropsA103eResource({
    ...context?.params,
  })
  return {
    props: {
